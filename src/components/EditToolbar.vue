  ...
  <div class="edit-toolbar" :class="{ 'has-secondary': showSecondaryRow }">
    <div class="toolbar-row primary-row">
      ...
      <div class="tool-group">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M160 80c0-26.5 21.5-48 48-48l224 0c26.5 0 48 21.5 48 48l0 480c0 26.5-21.5 48-48 48l-224 0c-26.5 0-48-21.5-48-48l0-480zM320 272c44.2 0 80-35.8 80-80s-35.8-80-80-80s-80 35.8-80 80s35.8 80 80 80zM240 448c0 44.2 35.8 80 80 80s80-35.8 80-80s-35.8-80-80-80s-80 35.8-80 80z"/></svg>
        </button>
        <button
          v-if="previewTab === 'ansi'"
