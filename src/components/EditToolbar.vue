    ...
    <div class="toolbar-row primary-row">
      ...
      <div class="tool-group">
        ...
        ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <rect x="144" y="42" width="60" height="60" rx="8"/>
          <rect x="226" y="42" width="60" height="60" rx="8"/>
          <rect x="308" y="42" width="60" height="60" rx="8"/>
          <rect x="144" y="154" width="60" height="60" rx="8"/>
          <rect x="226" y="154" width="60" height="60" rx="8"/>
          <rect x="308" y="154" width="60" height="60" rx="8"/>
          <rect x="144" y="266" width="60" height="60" rx="8"/>
          <rect x="226" y="266" width="60" height="60" rx="8"/>
          <rect x="308" y="266" width="60" height="60" rx="8"/>
          <rect x="144" y="377" width="60" height="60" rx="8"/>
          <rect x="226" y="377" width="60" height="60" rx="8"/>
          <rect x="308" y="377" width="60" height="60" rx="8"/>
        </svg></button>
      </div>
